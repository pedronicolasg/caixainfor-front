...
<div class="w-full max-w-md mx-auto">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 animate-fade-in">
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl sm:text-3xl font-bold font-display text-gray-900 mb-2">Crie sua conta</h2>
            <p class="text-sm sm:text-base text-gray-600">Comece a gerenciar suas finanças hoje</p>
        </div>
        ...
        <form class="space-y-6" action="<?= base_url('/auth/signup') ?>" method="POST">
            ...
            <div>
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <i class="fa-solid fa-shield text-[1.25rem] leading-none text-gray-400" aria-hidden="true"></i>
                    </div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    Já tem uma conta?
                    <a href="<?= base_url('/auth/login') ?>" class="font-semibold font-display text-primary hover:text-blue-500 transition-colors duration-200">
                        Fazer login
                    </a>
                </p>
            </div>
