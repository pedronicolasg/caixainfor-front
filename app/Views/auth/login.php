...
<div class="w-full max-w-md mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-6 sm:p-8 animate-fade-in">
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl sm:text-3xl font-bold font-display text-gray-900 dark:text-white mb-2">Bem-vindo de volta!</h2>
            <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Entre na sua conta para continuar</p>
        </div>
        ...
        <form class="space-y-6" action="<?= base_url('/auth/login') ?>" method="POST">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Não tem uma conta?
                    <a href="<?= base_url('/auth/signup') ?>" class="font-semibold font-display text-primary dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors duration-200">
                        Criar conta
                    </a>
                </p>
            </div>
