...
<div class="space-y-6 animate-fade-in">
    <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl sm:text-3xl font-bold font-display text-gray-900 mb-2">Dashboard</h1>
                <p class="text-sm sm:text-base text-gray-600">Bem-vindo(a) de volta! Aqui está o resumo mensal das
                    finanças da turma.</p>
            </div>
    ...
    <?php if ($summary): ?>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div
                class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-green-100 overflow-hidden group">
                <div class="p-6">
                    ...
                    <h3 class="text-sm font-medium text-gray-600 mb-1">Entradas</h3>
                    <p class="text-3xl font-bold font-display text-gray-900">R$
            ...
            <div
                class="bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-red-100 overflow-hidden group">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div
                    ...
                    <h3 class="text-sm font-medium text-gray-600 mb-1">Saídas</h3>
                    <p class="text-3xl font-bold font-display text-gray-900">R$
            ...
            <div
                class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-indigo-100 overflow-hidden group">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div
                    ...
                    <h3 class="text-sm font-medium text-gray-600 mb-1">Saldo</h3>
                    <p
                        class="text-3xl font-bold font-display <?= ($summary['balance'] ?? 0) >= 0 ? 'text-green-600' : 'text-red-600' ?>">
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-xl font-bold font-display text-gray-900">Últimas Transações</h2>
                        <p class="text-sm text-gray-600 mt-1">Suas transações mais recentes</p>
                    </div>
                    <a href="<?= base_url('/transactions') ?>"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-primary hover:text-blue-700 hover:bg-indigo-50 rounded-lg transition-colors duration-200">
                        Ver todas
            ...
            <?php else: ?>
                <div class="divide-y divide-gray-100">
                    <?php foreach ($recentTransactions as $index => $transaction): ?>
                        <div class="px-6 py-4 hover:bg-gray-50 transition-colors duration-150 <?= $index === 0 ? 'animate-fade-in' : '' ?>"
                            style="animation-delay: <?= $index * 100 ?>ms">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4 flex-1 min-w-0">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-10 h-10 rounded-lg flex items-center justify-center <?= $transaction['type'] === 'income' ? 'bg-green-100' : 'bg-red-100' ?>">
                                            <?php if ($transaction['type'] === 'income'): ?>
                                                <i class="fa-solid fa-arrow-trend-up text-[1.25rem] leading-none text-green-600"
                                                    aria-hidden="true"></i>
                                            <?php else: ?>
                                                <i class="fa-solid fa-arrow-trend-down text-[1.25rem] leading-none text-red-600"
                                                    aria-hidden="true"></i>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center space-x-4 ml-4">
                                    ...
                                    <span
                                        class="px-2.5 py-1 text-xs font-semibold rounded-full <?= $transaction['type'] === 'income' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' ?>">
    ...
    <?php else: ?>
        <div class="bg-white rounded-2xl shadow-md p-12 text-center border border-gray-100">
            <div class="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
                <i class="fa-solid fa-arrows-rotate text-[2rem] leading-none text-primary" aria-hidden="true"></i>
            </div>
