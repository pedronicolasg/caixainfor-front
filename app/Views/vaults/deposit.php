...
<div class="max-w-xl mx-auto animate-fade-in">
    <div class="mb-6 sm:mb-8">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Mova dinheiro do saldo geral para a caixinha
            <strong class="text-gray-900 dark:text-gray-100"><?= esc($vault['name']) ?></strong>.
        </p>
    </div>

    <div class="card p-5 sm:p-6 lg:p-8">
        <form action="<?= base_url('/vaults/' . $vault['id'] . '/deposit') ?>" method="POST" class="space-y-6">
            <?= csrf_field() ?>
            ...
            <div>
                <label for="amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                    Valor a guardar <span class="text-red-500">*</span>
                </label>
                <div class="relative">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Este valor será movido do saldo geral para esta caixinha.
                </p>
            </div>
